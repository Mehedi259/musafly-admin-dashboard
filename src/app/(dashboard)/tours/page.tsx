    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-[#1a1d24] border border-[#2e3340] rounded-2xl shadow-xl mb-8 overflow-hidden animate-in slide-in-from-top-4 duration-300">
        ...
        <form onSubmit={handleSubmit} className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold text-[#94a3b8] uppercase tracking-wide">সময়কাল</label>
      ...
      <div className="bg-[#1a1d24] border border-[#2e3340] rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-[#252932] px-6 py-4 border-b border-[#2e3340]">
          <h2 className="text-lg font-bold text-white">বর্তমান ট্যুরসমূহ</h2>
        </div>
              ...
              {items.length === 0 ? (
                ...
                <tr key={item.id} className="hover:bg-[#252932] transition-colors group">
                  ...
                  <td className="p-4 border-t border-[#2e3340] text-white">
                    {item.image ? <img src={item.image.replace("http://46.225.103.236:8001", "").replace("https://admin.musafly.com", "")} alt={item.destination} className="w-12 h-12 object-cover rounded-lg border border-[#2e3340]" /> : <div className="w-12 h-12 bg-[#252932] rounded-lg border border-[#2e3340] flex items-center justify-center text-xs text-[#94a3b8]">N/A</div>}
                  </td>
