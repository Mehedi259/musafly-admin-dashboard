...
const API_URL = 'http://46.225.103.236:8001/api/flights/';
...
export default function FlightsPage() {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      <h1 className="text-4xl font-bold text-white mb-8">Manage Flights</h1>
      ...
      <div className="bg-[#1a1d24] border border-[#2e3340] rounded-2xl shadow-xl mb-8 overflow-hidden">
        <div className="bg-[#252932] px-6 py-4 border-b border-[#2e3340] flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-white">Add New Flight</h2>
        </div>
        <form onSubmit={handleSubmit} className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold text-[#94a3b8] uppercase tracking-wide">Airline</label>
            <input type="text" step="0.01" placeholder="Enter Airline" className="bg-[#0f1115] border border-[#2e3340] p-3 rounded-xl text-white focus:outline-none focus:border-[#5B9BD5] transition-colors" required
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold text-[#94a3b8] uppercase tracking-wide">Origin</label>
            <input type="text" step="0.01" placeholder="Enter Origin" className="bg-[#0f1115] border border-[#2e3340] p-3 rounded-xl text-white focus:outline-none focus:border-[#5B9BD5] transition-colors" required
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold text-[#94a3b8] uppercase tracking-wide">Departure Time</label>
            <input type="datetime-local" step="0.01" placeholder="Enter Departure Time" className="bg-[#0f1115] border border-[#2e3340] p-3 rounded-xl text-white focus:outline-none focus:border-[#5B9BD5] transition-colors" required
              value={formData.departure_time} onChange={e => setFormData({...formData, departure_time: e.target.value})} />
          </div>
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-semibold text-[#94a3b8] uppercase tracking-wide">Arrival Time</label>
            <input type="datetime-local" step="0.01" placeholder="Enter Arrival Time" className="bg-[#0f1115] border border-[#2e3340] p-3 rounded-xl text-white focus:outline-none focus:border-[#5B9BD5] transition-colors" required
      ...
      <div className="bg-[#1a1d24] border border-[#2e3340] rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-[#252932] px-6 py-4 border-b border-[#2e3340]">
          <h2 className="text-lg font-bold text-white">Current Flights</h2>
        </div>
          ...
          <table className="w-full text-sm">
            <thead className="bg-[#1a1d24]">
              <tr>
                ...
                <th className="p-4 text-left font-semibold text-[#94a3b8]">Airline</th>
<th className="p-4 text-left font-semibold text-[#94a3b8]">Route</th>
